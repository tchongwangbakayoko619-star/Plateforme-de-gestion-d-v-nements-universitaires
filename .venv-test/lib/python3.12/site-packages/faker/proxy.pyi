...
class Faker:
    ...
    def file_name(self, category: Optional[str] = ..., extension: Optional[str] = ...) -> str:
        ...
        """
        ...
    def file_path(self, depth: int = ..., category: Optional[str] = ..., extension: Union[str, Sequence[str], None] = ..., absolute: Optional[bool] = ..., file_system_rule: Literal['linux', 'windows'] = ..., allowed_path_traversal_elements: Optional[Sequence[str]] = ...) -> str:
        """
    ...
    def pybool(self, truth_probability: int = ...) -> bool:
        ...
        """
        ...
    def pydecimal(self, left_digits: Optional[int] = ..., right_digits: Optional[int] = ..., positive: Optional[bool] = ..., min_value: Union[float, int, Decimal, None] = ..., max_value: Union[float, int, Decimal, None] = ...) -> Decimal: ...
